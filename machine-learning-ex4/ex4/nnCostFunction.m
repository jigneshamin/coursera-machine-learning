...
for t=1:m
	...
	a1 = X(t,:);        % row vector - 1x401
	z2 = Theta1 * a1';  % column vector - 25x1

	a2 = sigmoid(z2);   % column vector - 25x1
	a2 = [1 ; a2];       % column vector - 26x1

	z3 = Theta2 * a2;   % column vector - 10x1
	a3 = sigmoid(z3);

	delta3 = a3 - y_k(:,t); % column vector - 10x1

	z2 = [1 ; z2];    % column vector - 26x1
	delta2 = (Theta2' * delta3) .* sigmoidGradient(z2);
	delta2 = delta2(2:end); % remove delta2(0)

	Theta1_grad = Theta1_grad + delta2 * a1;   % a1 is 1x401
	Theta2_grad = Theta2_grad + delta3 * a2';  % a2 is 26x1
end
