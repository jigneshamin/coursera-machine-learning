...
% theta = zeros(3, 1);
% [theta, J_history] = gradientDescentMulti(X, y, theta, alpha/10, num_iters);
...
% theta = zeros(3, 1);
% [theta, J_history] = gradientDescentMulti(X, y, theta, alpha/100, num_iters);
...
% theta = zeros(3, 1);
% [theta, J_history] = gradientDescentMulti(X, y, theta, alpha/1000, num_iters);
